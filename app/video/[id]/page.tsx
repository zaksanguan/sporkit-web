      ...
      <head>
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .logo-circle { width: 16px; height: 16px; border-radius: 50%; background: #FF8C00; display: flex; align-items: flex-start; justify-content: center; overflow: visible; flex-shrink: 0; }
        ...
        <div className="banner">
          <a href="https://sporkitapp.com" className="banner-logo">
            <div className="logo-circle">
              <svg width="8" height="14" viewBox="0 0 78 127" fill="none" xmlns="http://www.w3.org/2000/svg">
